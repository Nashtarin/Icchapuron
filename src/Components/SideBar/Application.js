    ...
    return (
     ...
     <div className='flex justify-between rounded-md  hover:bg-cyan-800 p-1'>
          ...
          <Link onClick={handler} to='/product'>
            ...
            <span className='text-slate-200 font-semibold'>Product</span>
          ...
          <Link onClick={handler} to='/order'>
            ...
            <span className='text-slate-200 font-semibold text-justify'>Order</span>
          ...
          <Link onClick={handler} to='/invoice'>
            ...
            <span className='text-slate-200 font-semibold text-justify'>Invoice</span>
          ...
          <Link onClick={handler} to='/todo'>
            ...
            <span className='text-slate-200 font-semibold text-justify mt-1'>Todo</span>
          ...
          <Link onClick={handler} to='/calender'>
            ...
            <span className='text-slate-200 font-semibold text-justify ml-3 mt-0'>Calender</span>
