  ...
  <Link onClick={handler} to='/chat'>
     ...
     <div className='flex justify-between rounded-md  hover:bg-cyan-800 p-1'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <span className='text-slate-200  mx-8 mt-1'>Error</span>
            {foarrow?<span onClick={foarrowHandler} className='px-6 mt-2 ml-16 text-xs'><FontAwesomeIcon icon={faArrowDown}/></span>   :<span onClick={foarrowHandler} className='px-6 mt-2 ml-10 text-xs'><FontAwesomeIcon icon={faArrowRight}/></span>}
            <br/>
